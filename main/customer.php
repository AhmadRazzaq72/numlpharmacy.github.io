...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav" style="width: min-content;">
			...
			<li class="active"><a href="customer.php"><i class="icon-group icon-2x" style="padding-left: 20px; color: black;"></i> Customers</a>                                    </li>
			<li><a href="supplier.php" style="padding-left: 20px;"><i class="icon-group icon-2x" style="padding-left: 14px;"></i> Suppliers</a>                                    </li>
			<li><a href="salesreport.php?d1=0&d2=0" style="padding-left: 30px;"><i class="icon-bar-chart icon-2x"></i> Sales Report</a>
					<br><br><br><br><br><br>		
			<li>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td>P <?php echo $row['p_total']; ?>.00</td>
