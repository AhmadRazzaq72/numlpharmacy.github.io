...
{ 
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('</head><body onLoad="self.print()" style="width: 800px; font-size: 13px; font-family: "Poppins", sans-serif;">');          
...
<?php include('navfixed.php');?>
	...
	<div class="well sidebar-nav" style="width: min-content;">
              ...
              <li ><a href="index.php"><i class="icon-dashboard icon-2x" style="padding-left: 18px;"></i> Dashboard </a></li> 
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center style="font-family: 'Poppins', sans-serif;"><div style="font:bold 25px 'Aleo';font-family: 'Poppins', sans-serif;">Sales Receipt</div>
	<br> NUML`s Pharmacy	<br>
	Jaranwalan Road Faisalabad	<br>	<br>
	</center>
	<div>
	<?php
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				?>
				<tr>
					<td colspan="5"style=" text-align:right;"><strong style="font-size: 12px; color: #222222;">Cash &nbsp;</strong></td>
