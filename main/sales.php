...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav" style="width: min-content;">
			  ...
			  <li class="active"><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>" style="padding-left: 30px; "><i class="icon-shopping-cart icon-2x" style="color:black;" ></i> Sales</a>  </li>             
